...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" minScale="1e+8" version="3.10.0-A Coruña" styleCategories="AllStyleCategories" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{ac7e2069-7826-418c-b37c-43484fd8dbde}">
      <rule symbol="0" filter=" &quot;fclass&quot; IN ( 'peak' )" label="peak" scalemindenom="1" scalemaxdenom="25001" key="{de51c0b6-5ed5-4619-9461-7e969018d091}"/>
    </rules>
    <symbols>
      <symbol type="marker" name="0" alpha="1" force_rhr="0" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="155,74,63,0"/>
          ...
          <prop k="outline_color" v="205,165,159,255"/>
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="214,183,178,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
  ...
  <labeling type="rule-based">
    <rules key="{5061c49e-d3d8-4116-b194-b579e59180c1}">
      <rule filter=" &quot;fclass&quot;  =  'peak' " description="peak" scalemindenom="1" scalemaxdenom="10000" key="{632f201f-fdd4-499c-8816-45933f55eff8}">
        <settings calloutType="simple">
          <text-style fontKerning="1" fontWordSpacing="0" fontUnderline="0" fontStrikeout="0" fieldName="name" namedStyle="Standard" fontCapitals="0" textColor="173,154,151,255" isExpression="0" useSubstitutions="0" fontItalic="0" previewBkgrdColor="0,0,0,255" textOpacity="1" fontWeight="50" multilineHeight="1" fontLetterSpacing="0" textOrientation="horizontal" fontSize="7" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontFamily="Open Sans">
