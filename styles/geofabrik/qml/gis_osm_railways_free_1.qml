...
<qgis hasScaleBasedVisibilityFlag="1" simplifyDrawingHints="1" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1" maxScale="1" minScale="1.2e+7" version="3.10.0-A Coruña" styleCategories="AllStyleCategories" readOnly="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{0d36de44-6814-4fea-a48c-d678277f9bd4}">
      <rule filter="&quot;fclass&quot; IN ('rail')" label="rail" key="{ef4a1766-84ef-49df-942e-f6ca90136319}">
        <rule symbol="0" label="1 - 1000" scalemindenom="1" scalemaxdenom="1000" key="{a137db37-cd31-4253-b1c5-3eb3db294309}"/>
        <rule symbol="1" label="1000 - 5000" scalemindenom="1000" scalemaxdenom="5000" key="{dfe0066e-e98c-46de-b4df-9f91460319f0}"/>
        <rule symbol="2" label="5000 - 10000" scalemindenom="5000" scalemaxdenom="10000" key="{b2f1f114-018d-4a4d-8729-254b207e1bdd}"/>
        <rule symbol="3" label="10000 - 50000" scalemindenom="10000" scalemaxdenom="50000" key="{6d9b7579-e7ca-4e6f-9b36-814bfa7cd4b7}"/>
        <rule symbol="4" label="50000 - 100000" scalemindenom="50000" scalemaxdenom="100000" key="{df961215-3ceb-4255-b7e5-8f0ffd109788}"/>
        <rule symbol="5" label="100000 - 500000" scalemindenom="100000" scalemaxdenom="500000" key="{39a38785-70c7-47f5-87f5-9da184cd62df}"/>
        <rule symbol="6" label="500000 - 1500000" scalemindenom="100000" scalemaxdenom="1500000" key="{db8eaeb2-9c8f-431a-aae1-e725341f6ec9}"/>
      </rule>
      <rule checkstate="0" filter="&quot;fclass&quot;  = 'subway'" label="subway" key="{1ae0a46a-29c6-40c6-90a1-ac7f052a6d45}">
        <rule checkstate="0" symbol="7" label="1 - 1000" scalemindenom="1" scalemaxdenom="1000" key="{bc7efc8d-5a88-4c29-bec5-7194fdcb6f47}"/>
        <rule checkstate="0" symbol="8" label="1000 - 5000" scalemindenom="1000" scalemaxdenom="5000" key="{ed4f3d6c-e478-43b7-b2b0-0fdcd80f1cc4}"/>
        <rule checkstate="0" symbol="9" label="5000 - 10000" scalemindenom="5000" scalemaxdenom="10000" key="{3a1c8d1a-563e-4aaa-bfce-1e7647844226}"/>
        <rule checkstate="0" symbol="10" label="10000 - 50000" scalemindenom="10000" scalemaxdenom="50000" key="{095f39e7-d491-4b7e-bef8-2ff8ce5ff69d}"/>
        <rule checkstate="0" symbol="11" label="50000 - 100000" scalemindenom="50000" scalemaxdenom="100000" key="{0286444b-3a16-4f64-9313-e204f69103fc}"/>
      </rule>
      <rule checkstate="0" filter="&quot;fclass&quot; IN ( 'tram', 'light_rail')" label="tram" key="{76cf0e67-e783-425f-9da4-513c917c8eba}">
        <rule symbol="12" label="1 - 1000" scalemindenom="1" scalemaxdenom="1000" key="{30f7ad94-e1d8-4579-962b-0e1d1254a653}"/>
        <rule symbol="13" label="1000 - 5000" scalemindenom="1000" scalemaxdenom="5000" key="{4c3f0b2e-0e66-4c1b-b2e1-1063068bc738}"/>
        <rule symbol="14" label="5000 - 10000" scalemindenom="5000" scalemaxdenom="10000" key="{b756372a-a933-4bbf-8851-94232a1ca414}"/>
        <rule symbol="15" label="10000 - 50000" scalemindenom="10000" scalemaxdenom="50000" key="{224012c7-b0ea-4651-9f64-fa3e400daca8}"/>
        <rule symbol="16" label="50000 - 100000" scalemindenom="50000" scalemaxdenom="100000" key="{370f9358-3cd7-4ef9-8009-14a3f28dcaaa}"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" fontWordSpacing="0" fontUnderline="0" fontStrikeout="0" fieldName="name" namedStyle="Bold Italic" fontCapitals="0" textColor="72,72,72,255" isExpression="0" useSubstitutions="0" fontItalic="1" previewBkgrdColor="0,0,0,255" textOpacity="1" fontWeight="75" multilineHeight="1" fontLetterSpacing="0" textOrientation="horizontal" fontSize="6.5" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontFamily="Noto Sans">
        <text-buffer bufferSize="0.5" bufferNoFill="0" bufferDraw="1" bufferOpacity="1" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferJoinStyle="64" bufferSizeUnits="MM"/>
      ...
      <text-format wrapChar="" rightDirectionSymbol=">" reverseDirectionSymbol="0" formatNumbers="0" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" plussign="0" leftDirectionSymbol="&lt;" decimals="3" multilineAlign="0" autoWrapLength="0" placeDirectionSymbol="0"/>
      <placement labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" xOffset="0" repeatDistance="80" layerType="LineGeometry" distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" preserveRotation="1" rotationAngle="0" centroidWhole="0" overrunDistanceUnit="MM" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0" repeatDistanceUnits="MM" offsetUnits="MapUnit" placement="3" placementFlags="9" priority="5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" centroidInside="0" distUnits="MM" maxCurvedCharAngleOut="-20" offsetType="0" yOffset="0" geometryGenerator="" maxCurvedCharAngleIn="20" geometryGeneratorEnabled="0"/>
      <rendering scaleMin="1" scaleVisibility="1" drawLabels="0" zIndex="0" fontLimitPixelSize="0" minFeatureSize="0" obstacleType="0" fontMaxPixelSize="10000" obstacle="1" obstacleFactor="1" mergeLines="1" fontMinPixelSize="3" labelPerPart="0" scaleMax="10000000" maxNumLabels="20" upsidedownLabels="0" limitNumLabels="0" displayAll="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
