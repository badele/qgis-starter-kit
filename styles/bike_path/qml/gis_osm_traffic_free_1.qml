...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" version="3.4.14-Madeira" simplifyAlgorithm="0" minScale="1e+8" simplifyDrawingHints="0" readOnly="0" labelsEnabled="0" maxScale="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" enableorderby="0" forceraster="0">
    <rules key="{cd36b31d-457b-4f2a-a7ab-8be85e886dc4}">
      <rule label="0 - 25000" key="{7e07cf7e-3319-4966-a746-77a05d7785a9}" scalemindenom="1" scalemaxdenom="25001">
        <rule filter="&quot;fclass&quot; = 'waterfall'" label="waterfall" key="{eec34236-3f3d-4bcb-8bce-6153f9bd0a04}" symbol="0" checkstate="0"/>
      </rule>
    </rules>
    <symbols>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;fclass&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="fclass" type="field" hidden="0" width="269"/>
      <column name="name" type="field" hidden="0" width="398"/>
