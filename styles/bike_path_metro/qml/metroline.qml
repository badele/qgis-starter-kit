...
<qgis simplifyDrawingHints="1" readOnly="0" maxScale="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" simplifyAlgorithm="0" version="3.10.2-A Coruña" simplifyLocal="1" minScale="1e+8" simplifyDrawingTol="1" simplifyMaxScale="1">
  <flags>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{18998ff9-5bac-4fd1-b1bc-d92178487b67}">
      <rule symbol="0" key="{1a8fb5a0-f695-4a01-848b-11b0381fe24b}" filter="&quot;line&quot; = 'Montpellier-Sète'" label="Sète"/>
      <rule symbol="1" key="{3c478e94-ed35-43c7-a057-63716517d41e}" filter=" &quot;line&quot; =  'Palavas-Montpellier' " label="Palavas"/>
      <rule symbol="2" key="{81810be0-24b2-4ddf-a2a9-f124114151eb}" filter=" &quot;line&quot; =  'Palavas-Sète' " label="Sète"/>
      <rule symbol="3" key="{74b05cab-7314-4134-bb11-45bbec7daf71}" filter=" &quot;line&quot; =  'Junction' " label="Jonction"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" type="line" name="0" alpha="1" clip_to_extent="1">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="245,130,32,255"/>
      ...
      <symbol force_rhr="0" type="line" name="1" alpha="1" clip_to_extent="1">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="239,62,66,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="10"/>
          <prop k="line_width_unit" v="Pixel"/>
          <prop k="offset" v="0"/>
      ...
      <symbol force_rhr="0" type="line" name="2" alpha="1" clip_to_extent="1">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="0,157,87,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="10"/>
          <prop k="line_width_unit" v="Pixel"/>
          <prop k="offset" v="0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" blendMode="0" useSubstitutions="0" textOpacity="1" fontWeight="50" fontLetterSpacing="0" fontSizeUnit="Point" namedStyle="Normal" fieldName="time" fontWordSpacing="0" textOrientation="horizontal" fontStrikeout="0" fontKerning="1" multilineHeight="1" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontCapitals="0" fontFamily="Sans Serif" textColor="0,0,0,255" fontSize="10" fontItalic="0" isExpression="0">
      ...
      <text-format addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;" formatNumbers="0" multilineAlign="4294967295" plussign="0" placeDirectionSymbol="0" autoWrapLength="0" rightDirectionSymbol=">" wrapChar="" decimals="3" reverseDirectionSymbol="0"/>
      <placement geometryGenerator="" centroidWhole="0" geometryGeneratorEnabled="0" maxCurvedCharAngleIn="25" geometryGeneratorType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" placement="3" repeatDistance="0" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" offsetUnits="MM" maxCurvedCharAngleOut="-25" layerType="LineGeometry" placementFlags="10" dist="2" preserveRotation="1" distUnits="MM" xOffset="0" centroidInside="0" fitInPolygonOnly="0" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" overrunDistanceUnit="MM" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceUnits="MM" yOffset="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="time"/>
    <constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="line"/>
  </constraints>
