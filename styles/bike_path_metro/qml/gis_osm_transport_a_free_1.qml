...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1" maxScale="0" minScale="1e+8" version="3.10.0-A Coruña" styleCategories="AllStyleCategories" readOnly="0">
  <flags>
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{6e91973e-b243-4f4b-a424-2e1e171306d4}">
      <rule label="0 - 25000" scalemindenom="1" scalemaxdenom="25001" key="{33d39f50-3b22-44f8-9aac-42d0ae4bcb58}">
        <rule symbol="0" filter="&quot;fclass&quot; = 'bus_station'" label="bus station" key="{0bc96d74-9ddf-4a5f-8b96-88b0d68ddf5b}"/>
        <rule symbol="1" filter="&quot;fclass&quot; = 'railway_station'" label="railway station" key="{14fb4a5c-9cb7-4a9c-ae43-427dc7fc90da}"/>
      </rule>
    </rules>
    <symbols>
      <symbol type="fill" name="0" alpha="1" force_rhr="0" clip_to_extent="1">
        <layer enabled="1" pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="175,156,141,255"/>
