...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" version="3.4.14-Madeira" simplifyAlgorithm="0" minScale="1e+8" simplifyDrawingHints="0" readOnly="0" labelsEnabled="0" maxScale="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" enableorderby="0" forceraster="0">
    <rules key="{fe2f8ae3-4802-442f-93aa-3789f5270da2}">
      <rule key="{351b7756-5151-407b-a498-4458bf1407ae}" scalemindenom="1000" symbol="0" scalemaxdenom="10000"/>
    </rules>
    <symbols>
      <symbol name="0" clip_to_extent="1" type="marker" alpha="1" force_rhr="0">
        <layer locked="0" enabled="1" pass="0" class="SimpleMarker">
          <prop v="0" k="angle"/>
          <prop v="193,230,198,255" k="color"/>
          ...
          <prop v="171,204,175,255" k="outline_color"/>
